...
import com.example.appsyrs.activity.FriendsAddActivity;
import com.example.appsyrs.adapter.FriendsAdapter;
import com.example.appsyrs.click.LoadFriendsCallback;
import com.example.appsyrs.db.FriendsHelper;
import com.example.appsyrs.entity.Friends;

import java.lang.ref.WeakReference;
import java.util.ArrayList;

import static com.example.appsyrs.activity.FriendsAddActivity.REQUEST_UPDATE;
...
public class FriendsFragment extends Fragment implements View.OnClickListener, LoadFriendsCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FloatingActionButton fabAdd = view.findViewById(R.id.fab);
